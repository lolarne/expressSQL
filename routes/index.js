...
// router.get('/games/:name', (request, response) => {
...
// router.get('/games/:type', (request, response) => {
...
// router.get('/games/:date', (request, response) => {
...
// router.get('/games/asc', (request, response) => {
